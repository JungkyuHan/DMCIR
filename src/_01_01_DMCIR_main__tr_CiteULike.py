...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DMCIR_Tr_CiteULike",
    ...
    model_file_name, log_file_name, result_file_name, i_gen_file_name = GetFileAllinOne_DMCIR(dataset="CL",
