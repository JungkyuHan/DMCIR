...
from _00_DMCIR_cfg import DMCIRCfg, GetFileAllinOne_DMCIRPlus
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DMCIRPlus_ML25M",
    ...
    parser.add_argument('--r_hlayers', type=int, nargs='+',  default=[128], help='rec hlayers')
    ...
    parser.add_argument('--r_epochs', type=int, default=10, help='rec epochs')
    ...
    model_file_name, log_file_name, result_file_name, i_gen_file_name = GetFileAllinOne_DMCIRPlus(dataset="ML",
